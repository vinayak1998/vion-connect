...
const partnerNavItems = [
  ...
  { title: "Installations", url: "/partner/installations", icon: Wrench },
  { title: "Tickets", url: "/partner/tickets", icon: Ticket },
];

export function PartnerSidebar() {
  const { signOut, partnerName } = useAuth();
  ...
  const NavItem = ({ item }: { item: typeof partnerNavItems[0] }) => (
    <SidebarMenuItem>
          ...
          <div className="flex items-center gap-2">
            ...
            {!isCollapsed && (
              <div className="flex flex-col">
                ...
                <Badge variant="secondary" className="text-xs w-fit">Partner</Badge>
              </div>
            )}
          </div>
          <Button
